...
<!-- custom-theme -->
<!--css links-->
<link href="<?php echo base_url('asset/haldepan/css/bootstrap.css');?>" rel="stylesheet" type="text/css" media="all" /><!--bootstrap-->
<link href="<?php echo base_url('asset/haldepan/css/font-awesome.css');?>" rel="stylesheet"><!--font-awesome-->
<link rel="stylesheet" href="<?php echo base_url('asset/haldepan/css/chocolat.css');?>" type="text/css" media="screen"><!--Gallery-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url('asset/haldepan/css/style3.css');?>" /><!--Banner Text-->
<link rel="stylesheet" href="<?php echo base_url('asset/haldepan/css/flexslider.css');?>" type="text/css" media="screen" property="" /><!--Blog slider-->
<link href="<?php echo base_url('asset/haldepan/css/mislider.css');?>" rel="stylesheet" type="text/css" /><!--Testimonials-->
<link href="<?php echo base_url('asset/haldepan/css/mislider-custom.css');?>" rel="stylesheet" type="text/css" /><!--Testimonials-->
<link href="<?php echo base_url('asset/haldepan/css/style.css');?>" rel="stylesheet" type="text/css" media="all" /><!--stylesheet-->
<!--//css links-->
<!--fonts-->
	...
	<div class="container">
			...
			<div class="mis-stage"> 
				...
				<ol class="mis-slider">
					...
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> <img src="images/t6.jpg" alt=" " class="img-responsive" />
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3310.905017186956!2d-118.13580638471149!3d33.9178440806427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2cd6ce5075d39%3A0x94d6e161932df7de!2sSchoolsFirst+Federal+Credit+Union+-+Downey!5e0!3m2!1sen!2sin!4v1489051964245"></iframe>
			<div class="agile_footer_bottom_grids">
				<div class="container">
				<div class="agileits_w3layouts_mail">
						<div class="col-md-6 w3_agileits_mail_left">
							<div class="w3_agileits_mail_left1">
								<p class="wthree_address">Fusce quis leo in augue ultricies
								<span>(+010) 123 345 458</span></p>
							</div>
						</div>
						<div class="col-md-6 w3_agileits_mail_left">
							<div class="w3_agileits_mail_left1">
								<p class="wthree_address">Donec at massa nec sem eleifend
								<span>(+010) 123 345 458</span></p>
							</div>
						</div>
					<div class="clearfix"> </div>
...
<!-- //PopUp-Box-JavaScript -->
 <!--light-box-files -->
 <!-- testimonial-plugin -->
		<script src="<?php echo base_url('asset/haldepan/js/mislider.js');?>" type="text/javascript"></script>
		<script type="text/javascript">
			jQuery(function ($) {
...
<!-- //testimonial-plugin -->
<!-- flexSlider -->
	<script defer src="<?php echo base_url('asset/haldepan/js/jquery.flexslider.js');?>"></script>
	<script type="text/javascript">
...
<!-- //bottom to top arrow -->
<script type="text/javascript" src="<?php echo base_url('asset/haldepan/js/bootstrap-3.1.1.min.js')?>"></script>
</body>
</html>